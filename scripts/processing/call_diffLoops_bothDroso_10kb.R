...
loopCounts <- readRDS("data/processed/hic/hg38/h5/loops/bothDroso/bothDroso_loopCounts_10kb.rds")
...
## Make sure column names of matrix match with row names of colData
...
pdf(file = "plots/diffLoops_bothDroso_10kb_MA.pdf")
...
## save as .rds
saveRDS(diff_loopCounts, file = "data/processed/hic/hg38/diffLoops/bothDroso/diffLoops_bothDroso_10kb.rds")
