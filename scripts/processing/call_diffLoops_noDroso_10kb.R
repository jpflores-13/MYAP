...
loopCounts <- readRDS("data/processed/hic/hg38/h5/loops/noDroso/noDroso_loopCounts_10kb.rds")
...
pdf(file = "plots/diffLoops_noDroso_10kb_MA.pdf")
...
## save as .rds
saveRDS(diff_loopCounts, file = "data/processed/hic/hg38/diffLoops/noDroso/diffLoops_noDroso_10kb.rds")
