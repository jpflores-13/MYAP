...
saveRDS(normalized_gained, "data/processed/hic/loop_decay/noDroso/gainedLoops_1kb_max50_mh_index.rds")
...
saveRDS(normalized_nullSet, "data/processed/hic/loop_decay/noDroso/nullSet_1kb_max50_mh_index.rds")
...
saveRDS(normalized_dm, "data/processed/hic/loop_decay/noDroso/dmLoops_1kb_max50_mh_index.rds")

# load processed data and convert to dataframes ---------------------------

normalized_gained <- readRDS("data/processed/hic/loop_decay/noDroso/gainedLoops_1kb_max50_mh_index.rds")
...
normalized_nullSet <- readRDS("data/processed/hic/loop_decay/noDroso/nullSet_1kb_max50_mh_index.rds")
## convert to dataframe
Group_nullSet <- factor(0:50)
...
normalized_dm <- readRDS("data/processed/hic/loop_decay/noDroso/dmLoops_1kb_max50_mh_index.rds")
## convert to dataframe
Group_dm <- factor(0:50)
