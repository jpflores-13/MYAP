...
# saveRDS(normalized_ctcf, "data/processed/hic/loop_decay/noDroso/ctcfLoops_1kb_max100_mh_index.rds")
...
for(i in seq_along(dmLoops)){
  for(j in 1:101){
    a <- normalized_dm[i,1]-normalized_dm[i,101]
    b <- normalized_dm[i,j]-normalized_dm[i,101]
...
saveRDS(normalized_dm, "data/processed/hic/loop_decay/noDroso/dmLoops_1kb_max100_mh_index.rds")
...
# normalized_ctcf <- readRDS("data/processed/hic/loop_decay/noDroso/ctcfLoops_1kb_max100_mh_index.rds")
# ## convert to dataframe
# Group_ctcf <- factor(0:100)
