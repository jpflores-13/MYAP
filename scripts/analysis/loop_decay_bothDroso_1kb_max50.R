...
saveRDS(normalized_gained, "data/processed/hic/hg38/loop_decay/bothDroso/gainedLoops_bothDroso_1kb_max50_mh_index.rds")
...
saveRDS(normalized_nullSet, "data/processed/hic/hg38/loop_decay/bothDroso/nullSet_bothDroso_1kb_max50_mh_index.rds")
...
saveRDS(normalized_ctcf, "data/processed/hic/hg38/loop_decay/bothDroso/ctcfLoops_bothDroso_1kb_max50_mh_index.rds")
...
normalized_gained <- readRDS("data/processed/hic/hg38/loop_decay/bothDroso/gainedLoops_bothDroso_1kb_max50_mh_index.rds")
...
normalized_nullSet <- readRDS("data/processed/hic/hg38/loop_decay/bothDroso/nullSet_bothDroso_1kb_max50_mh_index.rds")
## convert to dataframe
Group_nullSet <- factor(0:50)
...
normalized_dm <- readRDS("data/processed/hic/dm6/loop_decay/dmLoops_bothDroso_1kb_max50_mh_index.rds")
## convert to dataframe
Group_dm <- factor(0:50)
...
normalized_ctcf <- readRDS("data/processed/hic/hg38/loop_decay/bothDroso/ctcfLoops_bothDroso_1kb_max50_mh_index.rds")
## convert to dataframe
Group_ctcf <- factor(0:50)
...
ggsave("plots/loop_decay_bothDroso_1kb_max50.pdf", loop_decay_plot, device = "pdf")
