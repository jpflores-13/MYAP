...
loops <- readRDS("data/processed/hic/hg38/diffLoops/HCT/hct_noDroso_10kb.rds") |> 
  interactions()
...
loops <- loops[mcols(loops)$loop_type == c("lost") &
...
# saveRDS(loops, "data/processed/fish/fish_LostLoopCandidates_hct.rds")
...
##make pdf
pdf(file = "plots/findFISHcandidates_lost_hct.pdf",
    width = 5.75,
    height = 5.6)

## Loop through each region
for(i in seq_along(loops_buffed)[1:100]){
  ## Define parameters
